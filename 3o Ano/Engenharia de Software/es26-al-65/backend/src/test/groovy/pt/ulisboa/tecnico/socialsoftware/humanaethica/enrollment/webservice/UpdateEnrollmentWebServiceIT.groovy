...
class UpdateEnrollmentWebServiceIT extends SpockTest {
    ...
    def setup() {
        ...
        and:
        shift = createShift(activity, IN_TWO_DAYS.plusHours(1), IN_TWO_DAYS.plusHours(3), 3, SHIFT_LOCATION)
        shift2 = createShift(activity, IN_TWO_DAYS.plusHours(3), IN_TWO_DAYS.plusHours(5), 1, SHIFT_LOCATION)
        and:
    ...
    def 'login as a volunteer and edit an enrollment'() {
        ...
        enrollmentDtoEdit.shiftIds = [shift.id, shift2.id]
