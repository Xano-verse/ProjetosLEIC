...
# 15 "papiStdEventDefs.h"
# 1 "papi_components_config_event_defs.h" 1
# 16 "papiStdEventDefs.h" 2
...
typedef void *vptr_t;
   ...
   typedef struct _papi_component_option {
     ...
     int disabled;
     char partially_disabled_reason[1024];
     int partially_disabled;
     int initialized;
     int CmpIdx;
     int num_cntrs;
     int num_mpx_cntrs;
