...
INTEGER PAPI_MAX_COMP_QUALS
PARAMETER(PAPI_MAX_COMP_QUALS=8)
...
PARAMETER(PAPI_NTV_ENUM_DARR=21)
...
PARAMETER(PAPI_VER_CURRENT=117571584)
...
PARAMETER(PAPI_NTV_ENUM_UMASK_COMBOS=19)
...
PARAMETER(PAPI_VERSION=117571584)
...
PARAMETER(PAPI_NTV_ENUM_IARR=20)
...
PARAMETER(PAPI_NTV_ENUM_IEAR=23)
INTEGER PAPI_NTV_ENUM_UMASKS
PARAMETER(PAPI_NTV_ENUM_UMASKS=18)
...
PARAMETER(PAPI_NTV_ENUM_OPCM=22)
...
INTEGER PAPI_PARTIAL      
PARAMETER(PAPI_PARTIAL=-28)
...
PARAMETER(PAPI_NTV_ENUM_DEAR=24)
