...
/// Parses input from the given file descriptor, according to KVS specification.
...
/// @return 0 if the command was not parsed successfully,
///         otherwise return the of keys parsed
